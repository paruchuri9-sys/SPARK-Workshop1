(function(){
  ...
  // Do not prime the initial judgment with a stakeholder checklist. Stakeholder
  // completeness remains part of scenario design, but noticing affected parties can
  // itself be an authentic reasoning move.
